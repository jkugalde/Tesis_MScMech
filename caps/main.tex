...
Se estudia de manera experimental el potencial del uso de la técnica de coldpsray (proyección de partículas en frío) como método de manufactura aditiva para piezas 3D con precisión cercana a la forma final (\textit{near net shape}), usando específicamente una microtobera con garganta de 1 mm, nitrógeno como gas portante, aleación de aluminio como sustrato, y polvo de aleación de titanio Ti6Al-4V.
...
Se caracteriza el perfil de deposición y se prueban diversas estrategias de compensación de paredes. Repasar los costados de las paredes con la herramienta en ángulo demuestra SER BKN PORKE BAJA EL SKEWNESS.

 Usando combinaciones de parámetros y trayectorias se generan probetas, las cuales son caracterizadas respecto a su resistencia mecánica, y piezas sencillas, cuya resolución se compara con el diseño de referencia.

Y QUE PASO. no c po, decir que las piezas no son tan fuertes, pero que si se tratan termicamente quedan mas bknes, y que la forma ideal de implementar este proceso seria en un sistema hibrido, donde capa a capa se alterne el fresado con el spray.
