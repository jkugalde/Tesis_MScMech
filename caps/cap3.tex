...
Para estos experimentos, el sustrato constituye un elemento de sacrificio, pues lo que se desea obtener es la pieza depositada, por esto, el criterio de selección de sustrato debe maximizar la facilidad de adehsión mas que alguna otra característica.

El sustrato elegido corresponde a aluminio 1100 suministrado en formato de plancha de 5 mm de espesor. Este material fue seleccionado por su disponibilidad comercial y por sus propiedades mecánicas, lo cual lo hace un sustrato habitual en experimentos de CS. Destaca su bajo límite de fluencia y alta plasticidad. El sustrato se corta mediante sierra y CNC en distitnasgeometrías dependiendo del experimento a realizar. 

A pesar de la rápida formación de una capa de óxido nativo en el aluminio —principalmente Al2O3, de alta dureza y estabilidad—, esto no constituye una limitación crítica para el proceso de cold spray. Durante el impacto a alta velocidad de las partículas de Ti, la energía cinética es suficiente para inducir deformación plástica localizada y fractura del óxido, permitiendo el contacto metal–metal necesario para la adhesión. De forma similar, la alta conductividad térmica del Aluminum 1100 no representa una desventaja, ya que favorece la distribución homogénea del calor generado por el gas de proceso o el precalentamiento externo, evitando gradientes térmicos locales y manteniendo condiciones estables en la superficie. En conjunto, tanto la presencia de una capa de óxido como la elevada conductividad térmica no impiden el desarrollo del depósito, debido a que el mecanismo de unión en cold spray está dominado por fenómenos de deformación plástica adiabática y activación interfacial bajo impacto supersónico.

En el caso del Aluminum 1100, su comportamiento como sustrato en cold spray se caracteriza por una microestructura esencialmente monofásica de alfa-Al con baja presencia de precipitados, lo que le confiere una respuesta plástica homogénea y un endurecimiento por deformación progresivo bajo impacto a alta velocidad. Esta capacidad de deformación localizada favorece el colapso superficial continuo y la ruptura de la capa de óxido, promoviendo el contacto íntimo metal–metal con las partículas de titanio. En estas condiciones, es posible la formación de uniones interfaciales de naturaleza metalúrgica a escala local entre el Al y el Ti, asociadas a alta presión y deformación adiabática durante el impacto, lo que facilita la transición desde el régimen erosivo inicial hacia la deposición estable del recubrimiento.
