...
\textbf{deposición oblicua} definida por Chepillo et al. y Wu et al., la cual consiste en 
...
La nomenclatura para referise a las trayectorias corresponde a pistas principales, las cuales definen la geoemtría de la pieza y la tobera aplica el material de manera normal a la superficie, y las pistas de corrección, donde la tobera aplica el material de manera oblicua para compensar la pérdida de borde.

Si bien, no es análoga la designación FDM a este caso entre definir infills para el material interno y wall para el material perimetral, pues ciertamente, no es factible generar estrcutras de soporte interior que ahorren material, sí podria definirse de todas maneras al material interior como relleno o infill, y a las paredes exteriroes simplemente como paredes. Así, las trayectorias interiores de deposicion oblicua se pueden denominar pistas principales de relleno.

Para la fabricación de tales sectores volumétricos (o de relleno), resulta más conveniente 
...
principales de relleno, o \textbf{deposición inter-trazo}, hasta alcanzar una planitud aceptable. Así, estas trayectorias se denominarian pistas inter-trazo.
...
Por esto, y por los resultados de Vargas-Uscategui et. al, es necesario definir una acción par amitigar este efecto, considerando ademas que la deposicion es continua. Se plantea que las geometrías a fabricar no puden contar con bordes rectos, sino que con cierta curvatura mínima, en el caso de generar un perímetro de forma contínua. 

Otra estrategia para cubrir el área que ocupará parte de una pieza es mediante un raster paralelo bidireccional. Dado que la despoicion es continiua, se deben buscar maneras para minimizar la deposicion en las zonas de transdicion entre cada pista principal, como el aumento de velocidad, la reduccion de angulo, y el alejamiento de la zona de deposicion.


Cabe mencionar que ciertas limitaciones serán propias de cada estrategia. La deposición con 
...
Lso valores obtebidos en Chepillo et al para los rangos operativos del proceso no son directamente homologables para el rpesente trabajo, pues las simulaciones realziadas suceden en condiciones ideales, sin efectos inerciales de la máquina, y se basan en el uso de cobre como material y aluminio como sustrato.
