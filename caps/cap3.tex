...
El objetivo de este trabajo es una evaluación experimental de fabricar de manera aditiva piezas de titanio por CSAM. Para tales efectos, el flujo general requiere de un sistema robotizado o CNC, estrategias de deposición y metodologías de evaluación.

Dado que no existen en la infraestuctura de la Universidad de Chile sistemas estbalecidos de coldspray con más de 3 ejes de libertad, pues se reuqiere la variación del angulo de depsoicion para una exploracion fundamentada en el estado del arte, se plantea implementar un sistema de CSAM a aprtir de la adaptacipoin de una maquina CNC y su integración con compontentes de CS. La caracterización del sistema y los materiales de trabajo constituirían la primera fase del trabajo, concluynedo con la entrega de los rangos de los aprametros de hardware y operativos del sistema establceido, una vez que se demuestre que existe deposicion viable.

 Se plantea el inicio de la exploracion experimental del trabajo partiendo por la caracterizacion de trazos unicapa, lo cual corresponderia a la etapa 2, cubriendo aspectos como el perfil de deposicion, evaluacion de compensacion angular y solapamiento, asi como tambien de las trayectorias curvilineas, buscando optimizar la construccion de paredes homogeneas, y proyectando la resolución del proceso.

En la etapa 3 se estudia la construcción de capas sucesivas sobre depósitos previos, buscando estrategias que permitan mantener una estructura de pared homogénea y plana conforme se avanza en la dirección $Z$. De este modo, se establecen los parámetros que habilitan la fabricación de geometrías tridimensionales elementales en el sistema, así como sus limitaciones. Estas geometrías primitivas se fabrican y se iteran, tanto en diseño como en parámetros de proceso, hasta obtener resultados morfológicamente aceptables y un proceso repetible.
...
De lo anterior, se estbalce entonces un flujo de trabajo con 4 etapas principales como muestra la Figura \ref{fig:etapas}. Estas etapas son secuenciales, puesto que cada una funciona como insumo para la ejecución de la siguiente.
